        ...
        <section id="tabs">
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <button class="nav-link" id="nav-fashion-tab" data-bs-toggle="tab" data-bs-target="#nav-fashion"
                        type="button" role="tab" aria-controls="nav-fashion" aria-selected="false">
                        Fashion
                    </button>
                    ...
                    <div class="container mt-4 mb-4">
                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <div class="col-md-3 col-sm-6">
                                ...
                                <img src="pictures/Popular/Logo/Dorall-collection.png" class="mb-4" width="70%"
                                    alt="" />
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <div class="card text-white brand-tab-img">
